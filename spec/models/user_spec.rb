...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    context '新規登録できるとき' do
      ...
      it 'last_nameが全角漢字、かなであれば登録できる' do
        @user.last_name = '田中'
        expect(@user).to be_valid
      end
      it 'first_nameが全角漢字、かなであれば登録できる' do
        @user.first_name = '太郎'
        expect(@user).to be_valid
      end
      it 'katakana_last_nameが全角カナであれば登録できる' do
        @user.katakana_last_name = 'タナカ'
        expect(@user).to be_valid
      end
      it 'katakana_first_nameが全角カナであれば登録できる' do
    ...
    context '新規登録できないとき' do
      ...
      it 'last_nameが全角漢字、かな以外では登録できない' do
        @user.last_name = 'タナカ'
        @user.valid?
        expect(@user.errors.full_messages).to include("Last name is invalid")
      end
      it 'first_nameが全角漢字、かな以外では登録できない' do
        @user.first_name = 'タロウ'
        @user.valid?
